...
/**
 * Overriden methods may throw only the exceptions specified in their base-class verions,
...
public class StormyInning extends Inning implements Storm{
	// OK to add new exception for constructors,but you must deal with the base constructor exceptions:
